 ...
 * @since 5.0.0
 */
public class ResumeSubscriptionHandler extends AbstractOperationHandler {

    public ResumeSubscriptionHandler() {
	...
	protected void setOperationsMetadata(OwsOperation operation,
		...
		// TODO Implement pub-sub resume subscription operations metadata
	}

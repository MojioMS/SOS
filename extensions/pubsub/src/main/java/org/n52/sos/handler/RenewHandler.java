...
import org.n52.sos.response.RenewResponse;
 ...
 * @since 5.0.0
 */
public class RenewHandler extends AbstractOperationHandler {

    public RenewHandler() {
        super(PubSubConstants.SERVICE, PubSubConstants.Operations.Renew.name());
    }

    public RenewResponse getRenew(RenewRequest request) {
	...
	protected void setOperationsMetadata(OwsOperation operation,
		...
		// TODO Implement Renew operations metadata
	}
